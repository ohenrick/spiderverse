...
O projeto consiste em uma aplicação interativa inspirada no universo do filme Spider-man: Across the Spider-verse, usando as principais stacks front-end: React, Next.js 13, a biblioteca Framer Motion, Sass e TypeScript para criar um projeto visual incrível e de alta performance. Projeto Spider-Verse, desenvolvido em parceria com a [DIO](https://dio.me) com os ensinamentos da [Michele Ambrosio](https://github.com/micheleambrosio).
